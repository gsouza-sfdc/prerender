...
const INJECT_SHADY_DOM = process.env.INJECT_SHADY_DOM || false;

const OMIT_PRERENDER_HEADER = process.env.OMIT_PRERENDER_HEADER || false;
...
server.init = function(options) {
  ...
  this.options.injectShadyDOM = this.options.injectShadyDOM || INJECT_SHADY_DOM;
  this.options.omitPrerenderHeader = this.options.omitPrerenderHeader || OMIT_PRERENDER_HEADER;
...
server.onRequest = function(req, res) {
	...
	.then(() => {
		...
		return this.browser.loadUrlThenWaitForPageLoadEvent(req.prerender.tab, req.prerender.url, this.options.injectShadyDOM);
	}).then(() => {
